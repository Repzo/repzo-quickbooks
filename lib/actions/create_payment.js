...
export const create_payment = async (event, options) => {
    ...
    try {
        ...
        if ((_e = repzo_client.integration_meta) === null || _e === void 0 ? void 0 : _e.quickBooks_id) {
            const invoice_id = (_g = (_f = repzo_payment === null || repzo_payment === void 0 ? void 0 : repzo_payment.paymentsData) === null || _f === void 0 ? void 0 : _f.payments[0]) === null || _g === void 0 ? void 0 : _g.fullinvoice_id;
            if (!invoice_id) {
            ...
            await actionLog
                .addDetail(`⌛ Connecting to invoice ${(_h = repzo_invoice.integration_meta) === null || _h === void 0 ? void 0 : _h.DocNumber}`)
                .commit();
            let quickBooks_invoice_id = (_j = repzo_invoice.integration_meta) === null || _j === void 0 ? void 0 : _j.quickBooks_id;
            ...
            const quickbooks_payment = {
                ...
                CustomerRef: {
                    ...
                    value: (_k = repzo_client.integration_meta) === null || _k === void 0 ? void 0 : _k.quickBooks_id,
                },
                PrivateNote: `invoice ${(_l = repzo_invoice.integration_meta) === null || _l === void 0 ? void 0 : _l.quickBooks_DocNumber}`,
