...
export const create_customer = async (event, options) => {
    ...
    try {
        ...
        await actionLog
            .addDetail(`Start Creating Client - ${(_e = body === null || body === void 0 ? void 0 : body.serial_number) === null || _e === void 0 ? void 0 : _e.formatted}`)
            .commit();
        ...
        await actionLog
            .addDetail(`✅ Complete Repzo-Quickbooks: Customer - ${QB_customer_body === null || QB_customer_body === void 0 ? void 0 : QB_customer_body.DisplayName}`)
            .setStatus("success")
