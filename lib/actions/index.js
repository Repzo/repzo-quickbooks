...
export const actions = async (event, options) => {
    var _a, _b, _c;
    try {
        const action = (_a = event.queryStringParameters) === null || _a === void 0 ? void 0 : _a.action;
        console.log("🚀 ~ action", action);
        switch ((_b = event.queryStringParameters) === null || _b === void 0 ? void 0 : _b.action) {
            ...
            default:
                throw `Route: ${(_c = event.queryStringParameters) === null || _c === void 0 ? void 0 : _c.action} not found`;
        }
    }
    catch (e) {
