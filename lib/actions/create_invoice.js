...
export const create_invoice = async (event, options) => {
    ...
    try {
        ...
        const qbo = new QuickBooks({
            oauthToken: ((_c = options.oauth2_data) === null || _c === void 0 ? void 0 : _c.access_token) || "",
            realmId: ((_d = options.oauth2_data) === null || _d === void 0 ? void 0 : _d.realmId) || "",
        ...
        try {
            ...
            if (((_e = repzo_client.integration_meta) === null || _e === void 0 ? void 0 : _e.quickBooks_id) !== undefined) {
                invoice.CustomerRef.value =
                    (_f = repzo_client.integration_meta) === null || _f === void 0 ? void 0 : _f.quickBooks_id;
        ...
        if (res) {
            ...
            let integration_meta = {
                quickBooks_id: (_g = res.Invoice) === null || _g === void 0 ? void 0 : _g.Id,
                quickBooks_DocNumber: (_h = res.Invoice) === null || _h === void 0 ? void 0 : _h.DocNumber,
            };
            try {
        ...
        // commit action log
        await actionLog
            .addDetail(`✅ Complete Repzo-Quickbooks: Invoice DocNumber: - ${(_j = res.Invoice) === null || _j === void 0 ? void 0 : _j.DocNumber}`)
            .setStatus("success")
            .setBody(res)
            .commit();
    }
...
const prepareInvoiceLines = (repzo, repzo_invoice) => {
    ...
    return new Promise((resolve, reject) => {
        var _a;
        (_a = repzo_invoice.items) === null || _a === void 0 ? void 0 : _a.forEach(async (item, i, arr) => {
            var _a, _b, _c, _d, _e, _f, _g;
            try {
                let product = await repzo.product.get((_a = item.variant) === null || _a === void 0 ? void 0 : _a.product_id);
                if (((_b = product.integration_meta) === null || _b === void 0 ? void 0 : _b.quickBooks_id) !== undefined) {
                    Line.push({
                        Id: String(i + 1),
                        ...
                        SalesItemLineDetail: {
                            ...
                            ItemRef: {
                                name: product.name,
                                value: (_c = product.integration_meta) === null || _c === void 0 ? void 0 : _c.quickBooks_id,
                            },
                            // ClassRef: ReferenceType;
                            // ItemAccountRef?: ReferenceType;
                            TaxCodeRef: ((_d = item.tax) === null || _d === void 0 ? void 0 : _d.type) === "N/A" ? NON : TAX,
                        ...
                        LineNum: i + 1,
                        Description: `${(_e = item.measureunit) === null || _e === void 0 ? void 0 : _e.factor} /  ${(_f = item.measureunit) === null || _f === void 0 ? void 0 : _f.name}`,
                    });
                }
                else {
                    reject(`Product Not found .. ${(_g = item.variant) === null || _g === void 0 ? void 0 : _g.product_name}`);
                }
            }
            catch (e) {
                reject(e);
