...
export const items = async (commandEvent) => {
  ...
  const formData = commandEvent.app.formData || {};
  const options_formData = commandEvent.app.options_formData || {};
  // init Repzo object
  const repzo = new Repzo(
    formData === null || formData === void 0 ? void 0 : formData.repzoApiKey,
    {
  ...
  try {
    ...
    if (
      !(options_formData === null || options_formData === void 0
        ? void 0
        : options_formData.bench_time_client)
    ) {
      await commandLog
        .setStatus("skipped")
...
const sync_products_from_QuickBooks_to_repzo = async (repzo, qb, app) => {
  try {
