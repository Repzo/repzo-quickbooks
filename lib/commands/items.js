  ...
  try {
    ...
    for (
      ...
      let existProduct = repzo_products.find(
        ...
        } // i.integration_meta?.quickBooks_id === item.Id,
      );
      if (existProduct) {
        if (
          new Date(
            (_j =
              existProduct === null || existProduct === void 0
                ? void 0
                : existProduct.integration_meta) === null || _j === void 0
              ? void 0
              : _j.QuickBooks_last_sync
          ) <
          new Date(
            (_k = item.MetaData) === null || _k === void 0
              ? void 0
              : _k.LastUpdatedTime
          )
        ) {
          ...
          (_l = repzo_product.variants) === null || _l === void 0
            ? void 0
            : _l.forEach((variant) => {
                var _a;
                // variant._id =
