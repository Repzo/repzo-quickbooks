...
export const items = async (commandEvent) => {
    ...
    try {
        ...
        result.quickBooks_total = (_e = (_d = qb_items.QueryResponse) === null || _d === void 0 ? void 0 : _d.Item) === null || _e === void 0 ? void 0 : _e.length;
        ...
        qb_items.QueryResponse.Item.forEach(async (item, index, array) => {
            var _a, _b, _c, _d;
            const repzo_default_category = await get_repzo_default_category(repzo, (_a = item.ParentRef) === null || _a === void 0 ? void 0 : _a.name);
            ...
            if (existProduct[0]) {
                if (new Date((_c = (_b = existProduct[0]) === null || _b === void 0 ? void 0 : _b.integration_meta) === null || _c === void 0 ? void 0 : _c.QuickBooks_last_sync) <
                    new Date((_d = item.MetaData) === null || _d === void 0 ? void 0 : _d.LastUpdatedTime)) {
 ...
 * @returns
 */
const map_products = (item, categoryID, company_namespace) => {
    return {
        name: item.Name,
