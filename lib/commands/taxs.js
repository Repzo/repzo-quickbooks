...
export const taxs = async (commandEvent) => {
    ...
    try {
        ...
        qb_taxs.QueryResponse.TaxRate.forEach(async (tax, index, array) => {
            var _a, _b, _c, _d;
            let existTax = repzo_taxs.filter((i) => { var _a; return ((_a = i.integration_meta) === null || _a === void 0 ? void 0 : _a.quickBooks_id) === tax.Id; });
            if (existTax[0]) {
                if (new Date((_b = (_a = existTax[0]) === null || _a === void 0 ? void 0 : _a.integration_meta) === null || _b === void 0 ? void 0 : _b.QuickBooks_last_sync) <
                    new Date((_c = tax.MetaData) === null || _c === void 0 ? void 0 : _c.LastUpdatedTime) ||
                    ((_d = existTax[0]) === null || _d === void 0 ? void 0 : _d.rate) !== Number(tax.RateValue) / 100) {
