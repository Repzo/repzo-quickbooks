...
export const customers = async (commandEvent) => {
    ...
    try {
        ...
        if (!((_d = commandEvent.app) === null || _d === void 0 ? void 0 : _d.options_formData[bench_time_key])) {
            await commandLog
        ...
        const qb_customers = await get_all_QuickBooks_customers(qbo, (_e = commandEvent.app.formData) === null || _e === void 0 ? void 0 : _e.bench_time_client);
        ...
        qb_customers.QueryResponse.Customer.forEach(async (cutomer, index, array) => {
            var _a, _b, _c;
