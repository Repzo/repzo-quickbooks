...
export const customers = async (commandEvent) => {
    ...
    try {
        ...
        await commandLog
            ...
            .commit();
        if (!((_e = (_d = commandEvent.app) === null || _d === void 0 ? void 0 : _d.options_formData) === null || _e === void 0 ? void 0 : _e.bench_time_client)) {
            await commandLog
                .setStatus("skipped")
        ...
        try {
            ...
            const qb_customers = await get_all_QuickBooks_customers(qbo, (_f = commandEvent.app.formData) === null || _f === void 0 ? void 0 : _f.bench_time_client);
            repzo_client = repzo_client.filter((i) => { var _a; return ((_a = i.integration_meta) === null || _a === void 0 ? void 0 : _a.QuickBooks_id) !== undefined; });
            Promise.all(promisify(qb_customers.QueryResponse.Customer, repzo_client, repzo))
                .then((values) => {
                var _a;
                commandLog
                    .addDetail(`Done : Sync ${values.length} Client , bench_time  ${(_a = commandEvent.app.formData) === null || _a === void 0 ? void 0 : _a.bench_time_client}`)
                    .commit();
            })
                .catch((err) => {
                console.error(err);
...
const promisify = (arr, repzo_client, repzo) => {
    let pro = [{}];
    pro.pop();
    arr.forEach((cutomer) => {
        var _a, _b, _c;
        let existClient = repzo_client.filter((i) => {
            var _a;
            return ((_a = i.integration_meta) === null || _a === void 0 ? void 0 : _a.QuickBooks_id) === cutomer.Id ||
                i.client_code === `QB_${cutomer.Id}`;
        });
        if (existClient[0]) {
            if (new Date((_b = (_a = existClient[0]) === null || _a === void 0 ? void 0 : _a.integration_meta) === null || _b === void 0 ? void 0 : _b.QuickBooks_last_sync) <
                new Date((_c = cutomer.MetaData) === null || _c === void 0 ? void 0 : _c.LastUpdatedTime)) {
...
const map_customers = (cutomer) => {
    ...
    return {
        ...
        country: (_a = cutomer.BillAddr) === null || _a === void 0 ? void 0 : _a.CountrySubDivisionCode,
        city: (_b = cutomer.BillAddr) === null || _b === void 0 ? void 0 : _b.City,
        lat: !isNaN(Number((_c = cutomer.BillAddr) === null || _c === void 0 ? void 0 : _c.Lat))
            ? Number((_d = cutomer.BillAddr) === null || _d === void 0 ? void 0 : _d.Lat)
            : 0.0,
        lng: !isNaN(Number((_e = cutomer.BillAddr) === null || _e === void 0 ? void 0 : _e.Long))
            ? Number((_f = cutomer.BillAddr) === null || _f === void 0 ? void 0 : _f.Long)
            : 0.0,
        integrated_client_balance: Number(cutomer.Balance) * 1000,
        cell_phone: (_g = cutomer.PrimaryPhone) === null || _g === void 0 ? void 0 : _g.FreeFormNumber,
        email: (_h = cutomer.PrimaryEmailAddr) === null || _h === void 0 ? void 0 : _h.Address,
        integration_meta: {
